    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_va') ? 'is-invalid' : '' }}" type="text" name="name_va" id="name_va" value="{{ old('name_va', $event->name_va) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::EVENT_TYP_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('event_typ') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="event_typ_{{ $key }}" name="event_typ" value="{{ $key }}" {{ old('event_typ', $event->event_typ) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('projektleiter_lt_orga') ? 'is-invalid' : '' }}" type="text" name="projektleiter_lt_orga" id="projektleiter_lt_orga" value="{{ old('projektleiter_lt_orga', $event->projektleiter_lt_orga) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gage') ? 'is-invalid' : '' }}" type="text" name="gage" id="gage" value="{{ old('gage', $event->gage) }}">
                @if($errors->has('gage'))
                    <div class="invalid-feedback">
                        {{ $errors->first('gage') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_location') ? 'is-invalid' : '' }}" type="text" name="event_location" id="event_location" value="{{ old('event_location', $event->event_location) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_start') ? 'is-invalid' : '' }}" type="text" name="event_start" id="event_start" value="{{ old('event_start', $event->event_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_finish') ? 'is-invalid' : '' }}" type="text" name="event_finish" id="event_finish" value="{{ old('event_finish', $event->event_finish) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('veranstaltungsmodul') ? 'is-invalid' : '' }}" type="text" name="veranstaltungsmodul" id="veranstaltungsmodul" value="{{ old('veranstaltungsmodul', $event->veranstaltungsmodul) }}">
            ...
            <div class="form-group">
                <label for="customer_name">{{ trans('cruds.event.fields.customer_name') }}</label>
                <input class="form-control {{ $errors->has('customer_name') ? 'is-invalid' : '' }}" type="text" name="customer_name" id="customer_name" value="{{ old('customer_name', $event->customer_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_description') ? 'is-invalid' : '' }}" type="text" name="event_description" id="event_description" value="{{ old('event_description', $event->event_description) }}">
            ...
            <div class="form-group">
                <label for="event_length">{{ trans('cruds.event.fields.event_length') }}</label>
                <input class="form-control {{ $errors->has('event_length') ? 'is-invalid' : '' }}" type="text" name="event_length" id="event_length" value="{{ old('event_length', $event->event_length) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auftraggeber') ? 'is-invalid' : '' }}" type="text" name="auftraggeber" id="auftraggeber" value="{{ old('auftraggeber', $event->auftraggeber) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asp_vorname') ? 'is-invalid' : '' }}" type="text" name="asp_vorname" id="asp_vorname" value="{{ old('asp_vorname', $event->asp_vorname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asp_name') ? 'is-invalid' : '' }}" type="text" name="asp_name" id="asp_name" value="{{ old('asp_name', $event->asp_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asp_strasse') ? 'is-invalid' : '' }}" type="text" name="asp_strasse" id="asp_strasse" value="{{ old('asp_strasse', $event->asp_strasse) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plz') ? 'is-invalid' : '' }}" type="text" name="plz" id="plz" value="{{ old('plz', $event->plz) }}">
                @if($errors->has('plz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('plz') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ort_kunde') ? 'is-invalid' : '' }}" type="text" name="ort_kunde" id="ort_kunde" value="{{ old('ort_kunde', $event->ort_kunde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefon_kunde') ? 'is-invalid' : '' }}" type="text" name="telefon_kunde" id="telefon_kunde" value="{{ old('telefon_kunde', $event->telefon_kunde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobil_kunde') ? 'is-invalid' : '' }}" type="text" name="mobil_kunde" id="mobil_kunde" value="{{ old('mobil_kunde', $event->mobil_kunde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_kunde') ? 'is-invalid' : '' }}" type="email" name="email_kunde" id="email_kunde" value="{{ old('email_kunde', $event->email_kunde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web') ? 'is-invalid' : '' }}" type="text" name="web" id="web" value="{{ old('web', $event->web) }}">
                @if($errors->has('web'))
                    <div class="invalid-feedback">
                        {{ $errors->first('web') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kst_abteilung') ? 'is-invalid' : '' }}" type="text" name="kst_abteilung" id="kst_abteilung" value="{{ old('kst_abteilung', $event->kst_abteilung) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('veranstaltungsland') ? 'is-invalid' : '' }}" type="text" name="veranstaltungsland" id="veranstaltungsland" value="{{ old('veranstaltungsland', $event->veranstaltungsland) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('destination') ? 'is-invalid' : '' }}" type="text" name="destination" id="destination" value="{{ old('destination', $event->destination) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asp_location') ? 'is-invalid' : '' }}" type="text" name="asp_location" id="asp_location" value="{{ old('asp_location', $event->asp_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_strasse') ? 'is-invalid' : '' }}" type="text" name="event_strasse" id="event_strasse" value="{{ old('event_strasse', $event->event_strasse) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_plz') ? 'is-invalid' : '' }}" type="number" name="event_plz" id="event_plz" value="{{ old('event_plz', $event->event_plz) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_ort') ? 'is-invalid' : '' }}" type="text" name="event_ort" id="event_ort" value="{{ old('event_ort', $event->event_ort) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_telefon') ? 'is-invalid' : '' }}" type="number" name="event_telefon" id="event_telefon" value="{{ old('event_telefon', $event->event_telefon) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_mobil') ? 'is-invalid' : '' }}" type="text" name="event_mobil" id="event_mobil" value="{{ old('event_mobil', $event->event_mobil) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_email') ? 'is-invalid' : '' }}" type="email" name="event_email" id="event_email" value="{{ old('event_email', $event->event_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anzahl_guides') ? 'is-invalid' : '' }}" type="number" name="anzahl_guides" id="anzahl_guides" value="{{ old('anzahl_guides', $event->anzahl_guides) }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::VERANSTALTUNGSART_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('veranstaltungsart') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="veranstaltungsart_{{ $key }}" name="veranstaltungsart" value="{{ $key }}" {{ old('veranstaltungsart', $event->veranstaltungsart) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::ALTERSSTRUKTUR_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('altersstruktur') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="altersstruktur_{{ $key }}" name="altersstruktur" value="{{ $key }}" {{ old('altersstruktur', $event->altersstruktur) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('regie_tl_vor_ort') ? 'is-invalid' : '' }}" type="text" name="regie_tl_vor_ort" id="regie_tl_vor_ort" value="{{ old('regie_tl_vor_ort', $event->regie_tl_vor_ort) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personenzahl') ? 'is-invalid' : '' }}" type="text" name="personenzahl" id="personenzahl" value="{{ old('personenzahl', $event->personenzahl) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('event_ablauf') ? 'is-invalid' : '' }}" name="event_ablauf" id="event_ablauf">{!! old('event_ablauf', $event->event_ablauf) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sprache_deutsch') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sprache_deutsch" id="sprache_deutsch" value="1" {{ $event->sprache_deutsch || old('sprache_deutsch', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sprache_englisch') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sprache_englisch" id="sprache_englisch" value="1" {{ $event->sprache_englisch || old('sprache_englisch', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sprache_bayrisch') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sprache_bayrisch" id="sprache_bayrisch" value="1" {{ $event->sprache_bayrisch || old('sprache_bayrisch', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sprache_schwabisch') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sprache_schwabisch" id="sprache_schwabisch" value="1" {{ $event->sprache_schwabisch || old('sprache_schwabisch', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sprache_schweiz') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sprache_schweiz" id="sprache_schweiz" value="1" {{ $event->sprache_schweiz || old('sprache_schweiz', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('event_notiz') ? 'is-invalid' : '' }}" name="event_notiz" id="event_notiz">{{ old('event_notiz', $event->event_notiz) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('event_teamkleidung') ? 'is-invalid' : '' }}" name="event_teamkleidung" id="event_teamkleidung">{{ old('event_teamkleidung', $event->event_teamkleidung) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teamverpflegung') ? 'is-invalid' : '' }}" type="text" name="teamverpflegung" id="teamverpflegung" value="{{ old('teamverpflegung', $event->teamverpflegung) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_logistik') ? 'is-invalid' : '' }}" type="text" name="event_logistik" id="event_logistik" value="{{ old('event_logistik', $event->event_logistik) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::VERTRIEBSWEG_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('vertriebsweg') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="vertriebsweg_{{ $key }}" name="vertriebsweg" value="{{ $key }}" {{ old('vertriebsweg', $event->vertriebsweg) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::PERSONEN_ZAHL_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('personen_zahl') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="personen_zahl_{{ $key }}" name="personen_zahl" value="{{ $key }}" {{ old('personen_zahl', $event->personen_zahl) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::JAHRESZEIT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jahreszeit') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jahreszeit_{{ $key }}" name="jahreszeit" value="{{ $key }}" {{ old('jahreszeit', $event->jahreszeit) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('interne_notiz') ? 'is-invalid' : '' }}" name="interne_notiz" id="interne_notiz">{{ old('interne_notiz', $event->interne_notiz) }}</textarea>
