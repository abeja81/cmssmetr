        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('event_incentive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="event_incentive" id="event_incentive" value="1" {{ $user->event_incentive || old('event_incentive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('krimi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="krimi" id="krimi" value="1" {{ $user->krimi || old('krimi', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('training') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="training" id="training" value="1" {{ $user->training || old('training', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('intern') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="intern" id="intern" value="1" {{ $user->intern || old('intern', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('moderation_vortrag') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="moderation_vortrag" id="moderation_vortrag" value="1" {{ $user->moderation_vortrag || old('moderation_vortrag', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_code') ? 'is-invalid' : '' }}" type="number" name="post_code" id="post_code" value="{{ old('post_code', $user->post_code) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="number" name="phone_number" id="phone_number" value="{{ old('phone_number', $user->phone_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_phone_number') ? 'is-invalid' : '' }}" type="number" name="mobile_phone_number" id="mobile_phone_number" value="{{ old('mobile_phone_number', $user->mobile_phone_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specials') ? 'is-invalid' : '' }}" type="text" name="specials" id="specials" value="{{ old('specials', $user->specials) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interna') ? 'is-invalid' : '' }}" type="text" name="interna" id="interna" value="{{ old('interna', $user->interna) }}">
