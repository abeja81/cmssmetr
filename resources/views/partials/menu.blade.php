<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('invitation_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.invitations.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/invitations") || request()->is("admin/invitations/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('sms_status_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.sms-statuses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/sms-statuses") || request()->is("admin/sms-statuses/*") ? "c-active" : "" }}">
                    <i class="fa-fw far fa-comments c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.smsStatus.title') }}
                </a>
            </li>
        @endcan
